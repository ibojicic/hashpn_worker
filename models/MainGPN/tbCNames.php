 ...
 */
class tbCNames extends Eloquent
{
    protected $table = 'tbCNames';
	...
	{
		return $this->belongsToMany(PNMain::class, 'PNMain_tbCName', 'idtbCName', 'idPNMain');
	}
}
