 ...
 */
class tblogFOIII extends Eloquent
{
	protected $table = 'tblogFOIII';
	protected $primaryKey = 'idtblogFOIII';
	...
	{
		return $this->belongsToMany(PNMain::class, 'PNMain_tblogFOIII', 'idtblogFOIII', 'idPNMain');
	}
}
