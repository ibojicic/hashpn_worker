 ...
 */
class tbPNMorph extends Eloquent
{
	protected $table = 'tbPNMorph';
	protected $primaryKey = 'idtbPNMorph';
	...
	{
		return $this->belongsTo(flagMap::class, 'flagMorph', 'flag');
	}
	...
	{
		return $this->belongsToMany(PNMain::class, 'PNMain_tbPNMorph', 'idtbPNMorph', 'idPNMain');
	}
}
