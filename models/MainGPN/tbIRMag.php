 ...
 * @property string $flagMag
 * @property float $Mag
 * @property float $errMag
 ...
 */
class tbIRMag extends Eloquent
{
	protected $table = 'tbIRMag';
	...
	{
		return $this->belongsTo(flagMap::class, 'flagMag', 'flag');
	}
	...
	{
		return $this->belongsToMany(PNMain::class, 'PNMain_tbIRMag', 'idtbIRMag', 'idPNMain')
					->withPivot('band');
	}
}
